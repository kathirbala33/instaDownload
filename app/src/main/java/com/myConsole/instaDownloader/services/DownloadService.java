package com.myConsole.instaDownloader.services;
...
import com.myConsole.instaDownloader.R;
import com.myConsole.instaDownloader.util.Constant;
import com.myConsole.instaDownloader.util.Events;
import com.myConsole.instaDownloader.util.Method;
...
public class DownloadService extends Service {
    ...
    private final Handler mHandler = new Handler(new Handler.Callback() {
        ...
        public boolean handleMessage(@NotNull Message message) {
            Log.d("DownloadService","Trigered" );
            Log.d("##SERDownloadService","Trigered" );
            Log.d("DownloadService","Message---> "+message);
...
//                        GlobalBus.getBus().post(adapterNotify);
    ...
    public void init(final String downloadUrl) {
        Log.d("DownloadServiceUrl",downloadUrl);
